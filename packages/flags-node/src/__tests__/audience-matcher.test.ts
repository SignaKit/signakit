...
import { matchesCondition, matchesAudience, matchesAudiences } from '../audience-matcher'
import type { AudienceCondition, ConfigRuleAudience } from '../types'
...
describe('matchesAudiences', () => {
  ...
  it('defaults to ALL logic when matchType is undefined', () => {
    ...
    // undefined matchType falls into the else branch (all)
