...
import type { RuleType, SignaKitDecision, VariableValue } from '@signakit/flags-browser'
...
export interface UseFlagResult {
   ...
   * Useful for branching UI on `'targeted'` rules (which fire no exposure events).
   */
